...
public class VideoClipUtils {
     ...
     */
    public static String clip(String srcPath, String outPath, double startTimeMs, double endTimeMs) throws IOException, IllegalArgumentException {
        ...
        //处理的时间以秒为单位
        double startTime = startTimeMs;
        double endTime = endTimeMs;
        LogUtil.logDebug(TAG, "--->>>>startTimeMs = " + startTimeMs + "\n endTimeMs = " + endTimeMs + "\n tracks.size = " + tracks.size());
        ...
        LogUtil.logDebug(TAG, "--->>>>startTime = " + startTime + "\n endTime = " + endTime);
        ...
        for (Track track : tracks) {
            ...
            LogUtil.logDebug(TAG, "track.getHandler() = " + track.getHandler() + "\n startSample1 = " + startSample1 + "\n endSample1 = " + endSample1);
